...
public class ifFirstTimeFrag extends android.support.v4.app.Fragment {
    private Button skip;
    private Button next;
    public ifFirstTimeFrag(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.iffirsttimefrag, container, false);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                android.support.v4.app.Fragment fr = new ifFirstTimeSecFrag();
